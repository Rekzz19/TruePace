...
export default function Dashboard({ isChatExpanded = false }: DashboardProps) {
        ...
        <CarouselContent className="h-full">
          ...
          <CarouselItem className="h-full">
            <div className="h-full flex flex-col md:flex-row gap-4">
              <div className="flex-1 h-full md:flex-1">
                <Card className="w-full h-full bg-neutral-900 border-neutral-800 text-white p-4 md:p-6 flex flex-col justify-between items-start min-h-60 md:min-h-80 overflow-hidden">
                  ...
                  {displayRun ? (
                    <div className="flex-1 flex flex-col overflow-auto">
                      ...
                      <div className="mt-3 md:mt-6 flex gap-2 md:gap-3 items-start min-h-11">
                        {displayRun.trainingPlan?.activityType === "RUN" &&
                        displayRun.status === "SKIPPED" ? (
                          <div className="text-xs md:text-sm text-red-400 self-center">
                          ...
                          <button
                            className="bg-white text-black px-3 md:px-6 py-1.5 md:py-2 rounded-full text-xs md:text-sm font-bold hover:bg-gray-200 transition"
                        ...
                        {displayRun.trainingPlan?.activityType === "RUN" &&
                          ...
                          displayRun.status !== "SKIPPED" && (
                            <button
                              className="bg-red-600 text-white px-3 md:px-6 py-1.5 md:py-2 rounded-full text-xs md:text-sm font-bold hover:bg-red-700 transition"
                        ...
                        {displayRun.trainingPlan?.activityType === "RUN" &&
                          !isDateInPast(displayRun.date) &&
                          !isDateToday(displayRun.date) && (
                            <div className="text-xs md:text-sm text-gray-400 self-center">
              ...
              >
                    ...
                    >
                      <div className="flex items-center gap-2 md:flex-col">
                        <div className="text-center">
                          <span className="text-xs md:text-xs text-gray-600 font-bold block">
                            {day.dayName}
                          </span>
                ...
                {currentWeek && (
                  <div className="mt-2 text-xs md:text-xs text-gray-500 text-center">
