    ...
    return (
        <main className="flex flex-col items-center justify-center min-h-screen bg-black text-white p-6 font-sans">
            ...
            <div className="text-center mb-10">
                ...
                <p className="text-gray-400 mt-2 text-lg">Let's personalise your running</p>
            </div>
            ...
            <div className="w-full max-w-md">
                <Card className="bg-[#111111] border-gray-800 shadow-2xl">
                    <CardHeader className="space-y-1">
                        ...
                        <CardDescription className="text-gray-500">Tell us about yourself</CardDescription>
                    </CardHeader>
                    ...
                    <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                        <CardContent className="space-y-4">
                            ...
                            {/* Height Field */}
                            <div className="space-y-2">
                                <Label htmlFor="height" className="text-sm font-medium text-gray-300">Height (feet)</Label>
                                <Input 
